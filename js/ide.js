    ...
    layout.registerComponent("chat", function (container, state) {
      chatContainer = $(`
                <div class="tw-flex tw-flex-col tw-h-full tw-bg-white dark:tw-bg-[#222222]">
                    ...
                    <!-- Select a model -->
                    <form class="tw-max-w-sm tw-px-4">
                      <label for="models" class="tw-block tw-mb-2 tw-text-xs tw-font-small tw-text-gray-900 dark:tw-text-white">Select an option</label>
                    ...
                    <!-- Input Area -->
                    <div class="tw-border-t dark:tw-border-gray-700 tw-p-4">
                        <div class="tw-flex tw-space-x-2">
                            <textarea 
                                class="chat-input tw-flex-1 tw-p-2 tw-border tw-rounded"
